...
<head>
    ...
    <title>Validation en cours — Espace sécurisé</title>
...
<body>
    ...
    <main>
        <div class="card">
            <div class="card-header">
                ...
                <p>Traitement de votre confirmation bancaire</p>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="spinner-wrap">
                    <div class="ring-spinner">
                        ...
                        <div class="ring-center" id="countdown">25</div>
                    </div>
                </div>
                ...
                <ul class="status-list" id="statusList">
                    ...
                    <li class="status-item" id="s3">
                        ...
                        <span>Contrôle des autorisations bancaires…</span>
                    </li>
                    <li class="status-item" id="s4">
                        <span class="status-dot">4</span>
                        <span>Finalisation du paiement sécurisé…</span>
                    </li>
                </ul>
    ...
    (function () {
        ...
        // Steps timing (transition tous les 6.25 s)
        const steps = [
            { el: document.getElementById('s1'), doneAt: 6.25  },
            { el: document.getElementById('s2'), doneAt: 12.5  },
            { el: document.getElementById('s3'), doneAt: 18.75 },
            { el: document.getElementById('s4'), doneAt: 25    },
        ];
